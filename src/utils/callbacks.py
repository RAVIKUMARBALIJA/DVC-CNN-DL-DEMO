...
def create_and_save_tensorboard_callabacks(callbacks_dir: str, tensorboard_logdir:str) -> None:
    ...
    pickle.dump(tb_callaback, open(tb_callaback_filepath))
...
def create_and_save_checkpointing_callback(callbacks_dir, model_checkpoint_dir):
    ...
    pickle.dump(checkpoint_callback, ckpt_callback_filepath)
