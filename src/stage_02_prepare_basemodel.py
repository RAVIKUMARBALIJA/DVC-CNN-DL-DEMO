...
from utils.model import get_base_model,get_unique_modelpath,prepare_fullmodel
...
def main(config_path, params_path):
    ...
    updated_model_path = os.path.join(base_model_dir_path,artifacts["UPDATED_BASE_MODEL_NAME"])
